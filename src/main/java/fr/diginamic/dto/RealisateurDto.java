...
/**
 * DTO (Data Transfer Object) pour la représentation d'un realisateur.
...
public class RealisateurDto {
     ...
     */
    public RealisateurDto(String id, String identite, String url, NaissanceDto naissance) {
        this.id = id;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("RealisateurDto{");
